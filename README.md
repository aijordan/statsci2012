...
To code makes and extensive use of the RandomFields R package which has been archived since the publication. However, it is still functioning and available at CRAN archive. Thus, for the code in this repo to work, install from source [RandomFieldsUtils](https://cran.r-project.org/src/contrib/Archive/RandomFieldsUtils/) (1.2.5) and [RandomFields](https://cran.r-project.org/src/contrib/Archive/RandomFields/) (3.3)
